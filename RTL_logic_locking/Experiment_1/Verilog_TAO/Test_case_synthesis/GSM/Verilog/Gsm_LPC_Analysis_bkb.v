...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module Gsm_LPC_Analysis_bkb_rom (
...
initial begin
    $readmemh("./Gsm_LPC_Analysis_bkb_rom.dat", ram0);
    $readmemh("./Gsm_LPC_Analysis_bkb_rom.dat", ram1);
end
...
Gsm_LPC_Analysis_bkb_rom Gsm_LPC_Analysis_bkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
