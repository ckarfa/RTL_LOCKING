S_0:
    ...
    if((!sig_key_9_9_) && ((in11%119) == 0)) {    // spurious transition
      goto S3;
    }
  ...
  if (((in2 == in1) == 1) == 1)  {
    reg_6 = in8 + in12 + in7;
    reg_1 = in14 - in15;
    if((!sig_key_11_11_) && ((in6%69) == 0)) {     // Spurious register transfer 
      reg_1 = 12458;
    }
    if((!sig_key_5_5_) && ((in7%79) == 0)) {    // Spurious register transfer  
      reg_6 = 12458;
    }
    goto S_1;
  }
